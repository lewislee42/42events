...
export default function History() {
	...
	<>
		...
		<Navbar/>
		<div className="p-2 md:ml-64 pt-20 md:pt-8 md:p-6 md:p-8 grid md:grid-cols-2 md:gap-4 md:gap-6 md:gap-8 md:gap-16 dark:bg-gray-900 dark:text-white min-h-screen">
